...
- `আজকে কি সাবমিট করবেঃ`
    ...
    - `Example:`
        ...
        - `@DemoDemo`
- [Contest Link:](https://www.hackerrank.com/contests/assignment-01-a-introduction-to-algorithms-a-batch-07/challenges)
- `এক্সাম দেওয়ার ডেড লাইনঃ`
    - অগাস্ট ২২ তারিখ রাত ১১.৫৯ এর মধ্যে সাবমিট করলে তোমার সর্বোচ্চ মার্কস হবে ১০০।
    - অগাস্ট ২৩ তারিখ রাত ১১.৫৯ এর মধ্যে জমা দিলে তোমার সর্বোচ্চ মার্কস হবে ৯০।
