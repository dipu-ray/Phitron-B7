...
## Topics:
- Exam Instruction: Module 04 [Must Read]
- Quiz Module 04
...
- আজকে কি সাবমিট করবেঃ
    ...
    - Example:
        ...
        - `@DemoName`
- [কন্টেস্ট লিংকঃ](https://www.hackerrank.com/mid-term-a-introduction-to-c-for-dsa-a-batch-07)
- এক্সাম দেওয়ার ডেড লাইনঃ
    - মে ৩১ তারিখ রাত ১১.৫৯ এর মধ্যে সাবমিট করলে তোমার সর্বোচ্চ মার্কস হবে ১০০। জুন ১ তারিখ রাত ১১.৫৯ এর মধ্যে জমা দিলে তোমার সর্বোচ্চ মার্কস হবে ৯০। আর এরপর যেকোন সময় জমা দিলে তোমার সর্বোচ্চ মার্কস হবে ৮০।
...
## Quiz Module 04
- Basic type questions of exam instructions related. `5 out of 5`

## 1. Mid Term Instructions
- Explanation this mid exam problems.

## Mid Term
- There is sumit section with profile link and username - `Hackerrank`