...
## Topics:
- Exam Instruction: Module 24 [Must Read]
- Quiz Module 24
- Final Instructions
- Final Exam

## Exam Instruction: Module 24 [Must Read]
- চমৎকার! তোমরা ডাটা স্ট্রাকচার এর মতো কোর ফান্ডামেন্টাল সাবজেক্টটা শেষ করে ফেলেছো। তবে কোর্স শেষ হলেও শেখার কিন্তু শেষ নাই। মাত্র যাত্রা শুরু হলো। যেতে হবে বহুদূর। কিন্তু কপি নামক জিনিসটা করলেই ব্যান। সো সেটা করতে যেওনা
- আজকে কি সাবমিট করবেঃ
    ...
    - Example:
        ...
        - `@DemoDemo`
- [কন্টেস্ট লিংকঃ](https://www.hackerrank.com/contests/final-exam-a-basic-data-structure-a-batch-07/challenges)
- এক্সাম দেওয়ার ডেড লাইনঃ
    - অগাস্ট ১১ তারিখ রাত ১১.৫৯ এর মধ্যে সাবমিট করলে তোমার সর্বোচ্চ মার্কস হবে ১০০। অগাস্ট ১৩ তারিখ রাত ১১.৫৯ এর মধ্যে জমা দিলে তোমার সর্বোচ্চ মার্কস হবে ৯০। আর এরপর যেকোন সময় জমা দিলে তোমার সর্বোচ্চ মার্কস হবে ৮০।
- গুরুত্বপূর্ন নির্দেশনাঃ
    ...
    - ৮) এক্সামের মার্ক্স রিলেটেড ডাউট থাকলে সাপোর্ট সেশনে গিয়ে ডাউট ক্লিয়ার করে নিবে, হেল্পডেস্কে পোস্ট না করাই উত্তম।
    - ৯) এক্সাম মার্কস রিলেটেড কোন কুয়েরি থাকলে ইমেইল করে দিতে হবে। হেল্পডেস্কে পোস্ট করলে ৫ মার্কস কেটে রাখা হবে।

## Quiz Module 24
- Here is 5 some basics questions before final exams. Likes: Text Instructions, Submit Deadline and not using AI tools.

## Final Instructions
- Explaination Final Exam wholes problems in this video.

## Final Exam
- You just submit final exam problem solve with hackerrank profile link and username. Thank you!